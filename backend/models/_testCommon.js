...
async function commonBeforeAll() {
  ...
  // userId1 = resultsUsers.rows[0].user_id;
  // userId2 = resultsUsers.rows[1].user_id;
  // userId3 = resultsUsers.rows[2].user_id;
  ...
  // postId = resultsPost.rows[0].post_id;
  ...
  //   commentId1 = resultComment.rows[0].comment_id;
  //   commentId2 = resultComment.rows[1].comment_id;
}
